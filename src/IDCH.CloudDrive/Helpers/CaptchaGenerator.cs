...
namespace IDCH.CloudDrive.Helpers
{
 ...
 HatchStyle.WideDownwardDiagonal, HatchStyle.WideUpwardDiagonal, HatchStyle.ZigZag
            ...
            var oBrush = default(System.Drawing.Brush);
            
            //Draw background (Lighter colors RGB 100 to 255)
            oBrush = new HatchBrush(aHatchStyles[oRandom.Next
                (aHatchStyles.Length - 1)], System.Drawing.Color.FromArgb((oRandom.Next(100, 255)),
                (oRandom.Next(100, 255)), (oRandom.Next(100, 255))), System.Drawing.Color.White);
            ...
            for (i = 0; i <= sCaptchaText.Length - 1; i++)
            {
                ...
                new SolidBrush(System.Drawing.Color.FromArgb(oRandom.Next(0, 100),
